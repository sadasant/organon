...
- Typed Denotation, paired-path Causal Contribution, constructive Capability realization, Standing, and recorded Evidential Bearing shadows from the [hidden-bridge audit](../hidden-bridge-audit.md). Finite witnesses show that Denotation need not be identity and supportive Evidential Bearing need not be Truth.
