...
- Body, Bodily Organization, Embodied Perspective, Recurrent Integration, and Internal Activity Selection have a finite [`EmbodiedConsciousness`](./EmbodiedConsciousness.lean) shadow. Its inhabited witness and seven countermodels test the promoted anti-entailments while retaining the consciousness condition as a proposal-local `CandidateCondition`; constituent parthood and process identity remain bounded local witnesses rather than universal theories.
