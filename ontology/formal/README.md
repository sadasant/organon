...
- A finite Truth shadow separates constructive conformity from Agent access, a Trust shadow binds a trustee-supplied future Transformation to an actual Causal path and Consequence without confidence or Permission, and an Alignment shadow proves conformity under one profile without identity, Truth, or cross-profile transfer.
