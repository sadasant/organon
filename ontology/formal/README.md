...
- Factive Operative Knowledge joins the exact Claim carried by an operative Record to Truth; Warranted Knowledge adds independently grounded and admitted Evidence for that same Claim. Finite countermodels separate useful falsehood, inaccessible true Claims, factivity, and warrant.
- Moral Status Attribution and Moral Personhood Designation repeat the candidate-Claim-CountsAs seam without defining moral worth. Four separate sovereignty structures witness constituent exercise, maximal constituted Authority, effective Boundary Control, and external Recognition. Preference, Utility Measure, Price, and institutional valuation remain separately satisfiable.
