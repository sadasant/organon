...
- Added a noncanonical finite relational experiment over the complete v0.15 registry. The generated Alloy model contains all 104 term records, all 34 commitment records, all 50 declared relation signatures, 110 concrete nodes, two joined cross-layer configurations, and explicit witnesses for the currently encoded positive joins, disjointness constraints, and anti-entailments. Alloy 6.2.0 found one global inhabitant. This establishes satisfiability of the structural projection only: 19 commitments have executable constraints and 15 remain exact metadata without full prose-semantic encodings.
