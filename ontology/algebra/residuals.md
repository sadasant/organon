...
- `C8` privacy and consciousness needs an explicit interiority/Exposure test;
- `C12` World and access-path convergence needs the complete World circuit;
...
3. a corpus-wide connective audit;
4. historical-version holdouts;
5. Lean or equivalent typed formalization of every promoted law;
6. proof that the law does not forbid the licensed institutional constitution
