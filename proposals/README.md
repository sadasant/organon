...
- [Embodiment and Recurrent Consciousness Candidate](./embodied-consciousness.md): ready for review with five supporting embodiment terms and one proposal-local candidate condition; the underlying consciousness condition remains quarantined.
...
- [Intelligence, Operative Knowledge, and Knowledge Transmission](./intelligence-operative-knowledge-transmission.md): promoted as adaptive Agent-level Capability, functioning Record-interpreter Configuration, and specified reconstruction, while bare knowledge remains quarantined.
- [Epistemic, moral, sovereign, and valuation profiles](./remaining-quarantine-profiles.md): partially promoted factive and warranted knowledge, moral discourse, four sovereignty profiles, and three valuation profiles while the generic terms and underlying conditions remain quarantined.
